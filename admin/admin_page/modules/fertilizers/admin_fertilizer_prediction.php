...
<body>
	...
	<!--<div class="topnav">
  	...
  	<section>
  		<nav>
  			<ul>
	  			<br><br><br><li style="background-color: #2980b9;"><a href="fertilizer_updation.php" target="iframe_a">Update</a></li><br><br>
	  			<li><a href="fertilizer_insertion.php" target="iframe_a">Insert</a></li><br><br>
	  			<li style="background-color: #c0392b;"><a href="fertilizer_deletion.php" target="iframe_a">Delete</a></li>
  			</ul>
  		</nav>
  		<midcontent>
