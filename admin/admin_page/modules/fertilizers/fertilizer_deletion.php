...
<html>
<head>
	<title>fertilizer deletion</title>
	<meta charset="utf-8">
...
<body>
	<div class="container">
				...
				<h3>Enter details</h3>
				<form action="fertilizer_deletion.php" method="POST">	
				...
				<?php
					if(isset($_POST['Delete']))
					{
						...
						$before=mysqli_query($con,"SELECT * FROM fertilizers_info");
						$query = "DELETE FROM fertilizers_info WHERE crop='$crop'";
						$result =mysqli_query($con,$query);
						$after=mysqli_query($con,"SELECT * FROM fertilizers_info");
						//if($result)
